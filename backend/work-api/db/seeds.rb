...
ExerciseSet.create(exercise_id: 1, workout_session_id: 1, reps: 5, weight: 75)
ExerciseSet.create(exercise_id: 2, workout_session_id: 1, reps: 8, weight: 125)
ExerciseSet.create(exercise_id: 3, workout_session_id: 1, reps: 12, weight: 70)
ExerciseSet.create(exercise_id: 1, workout_session_id: 1, reps: 5, weight: 75)
ExerciseSet.create(exercise_id: 4, workout_session_id: 2, reps: 5, weight: 0)